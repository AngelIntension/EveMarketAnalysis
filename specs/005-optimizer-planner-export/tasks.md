...
- [x] T001 Create `EveMarketAnalysisClient.Tests/Models/` directory if it does not exist
...
- [x] T018 [US3] Run full test suite: `dotnet test EveMarketAnalysisClient.Tests` to verify all new and existing tests pass.
